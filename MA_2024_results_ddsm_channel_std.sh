...
python3 ${SLURM_SUBMIT_DIR}/results_check_ddsm_channel_std.py --out_path 'path_simulation_plots_std50/s1/reflection' --file_path './sudoku/steps50.cat9.time1.0.samples50000.reflection.s1.pth'
"
